...
} elseif ($_instance->childHasBeenRendered('w12KHce')) {
    $componentId = $_instance->getRenderedChildComponentId('w12KHce');
    $componentTag = $_instance->getRenderedChildComponentTagName('w12KHce');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('w12KHce');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('w12KHce', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /home/u726706882/domains/tracking.ardata.co.id/public_html/resources/views/vendor/filament/components/layouts/card.blade.php ENDPATH**/ ?>