...
} elseif ($_instance->childHasBeenRendered('gmjaA37')) {
    $componentId = $_instance->getRenderedChildComponentId('gmjaA37');
    $componentTag = $_instance->getRenderedChildComponentTagName('gmjaA37');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('gmjaA37');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('gmjaA37', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('IRtdR2T')) {
    $componentId = $_instance->getRenderedChildComponentId('IRtdR2T');
    $componentTag = $_instance->getRenderedChildComponentTagName('IRtdR2T');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('IRtdR2T');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('IRtdR2T', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/u726706882/domains/tracking.ardata.co.id/public_html/resources/views/vendor/filament/components/topbar.blade.php ENDPATH**/ ?>