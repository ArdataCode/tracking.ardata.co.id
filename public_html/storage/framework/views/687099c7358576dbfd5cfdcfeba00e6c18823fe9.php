...
} elseif ($_instance->childHasBeenRendered('cybbiKl')) {
    $componentId = $_instance->getRenderedChildComponentId('cybbiKl');
    $componentTag = $_instance->getRenderedChildComponentTagName('cybbiKl');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('cybbiKl');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('cybbiKl', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /home/u726706882/domains/sistem.amanatkilatsemesta.com/public_html/resources/views/vendor/filament/components/layouts/card.blade.php ENDPATH**/ ?>