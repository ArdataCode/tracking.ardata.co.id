...
} elseif ($_instance->childHasBeenRendered('q5KbE8Y')) {
    $componentId = $_instance->getRenderedChildComponentId('q5KbE8Y');
    $componentTag = $_instance->getRenderedChildComponentTagName('q5KbE8Y');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('q5KbE8Y');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('q5KbE8Y', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('OMlIuf5')) {
    $componentId = $_instance->getRenderedChildComponentId('OMlIuf5');
    $componentTag = $_instance->getRenderedChildComponentTagName('OMlIuf5');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('OMlIuf5');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('OMlIuf5', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/1126019.cloudwaysapps.com/wduukqjrbn/public_html/resources/views/vendor/filament/components/topbar.blade.php ENDPATH**/ ?>