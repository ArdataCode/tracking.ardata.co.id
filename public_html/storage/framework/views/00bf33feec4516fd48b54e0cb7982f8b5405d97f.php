                ...
                <div class="elementor-widget-container">
                    ...
                    <ul class="elementor-icon-list-items elementor-inline-items">
                        <li class="elementor-icon-list-item elementor-inline-item">
                            ...
                            <span class="elementor-icon-list-text">(021) 87711707</span>
                        </li>
                        <li class="elementor-icon-list-item elementor-inline-item">
                            <span class="elementor-icon-list-icon"> <i aria-hidden="true" class="fab fa-whatsapp"></i></span>
                            <span class="elementor-icon-list-text">081282976820</span>
                        </li>
                        <li class="elementor-icon-list-item elementor-inline-item">
                            <span class="elementor-icon-list-icon"> <i aria-hidden="true" class="far fa-envelope"></i></span>
                            <span class="elementor-icon-list-text">admin@amanatkilatsemesta.com</span>
                        </li>
                        <li class="elementor-icon-list-item elementor-inline-item">
                            <span class="elementor-icon-list-icon"> <i aria-hidden="true" class="fas fa-map-marker-alt"></i></span>
                            <span class="elementor-icon-list-text">Jl. Taruna Jaya No. 95, Cibubur, Jakarta Timur</span>
                        </li>
                    </ul>
                </div>
            </div>
...
</section><?php /**PATH /home/u726706882/domains/sistem.amanatkilatsemesta.com/public_html/resources/views/frontend/footer.blade.php ENDPATH**/ ?>