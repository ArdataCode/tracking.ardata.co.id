...
} elseif ($_instance->childHasBeenRendered('GXeGatq')) {
    $componentId = $_instance->getRenderedChildComponentId('GXeGatq');
    $componentTag = $_instance->getRenderedChildComponentTagName('GXeGatq');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('GXeGatq');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('GXeGatq', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('1SOAaQl')) {
    $componentId = $_instance->getRenderedChildComponentId('1SOAaQl');
    $componentTag = $_instance->getRenderedChildComponentTagName('1SOAaQl');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1SOAaQl');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('1SOAaQl', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/u726706882/domains/sistem.amanatkilatsemesta.com/public_html/resources/views/vendor/filament/components/topbar.blade.php ENDPATH**/ ?>