...
} elseif ($_instance->childHasBeenRendered('7kG4LlO')) {
    $componentId = $_instance->getRenderedChildComponentId('7kG4LlO');
    $componentTag = $_instance->getRenderedChildComponentTagName('7kG4LlO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7kG4LlO');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('7kG4LlO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /home/1126019.cloudwaysapps.com/wduukqjrbn/public_html/resources/views/vendor/filament/components/layouts/card.blade.php ENDPATH**/ ?>